...
def has_valid_conversational_example(example: dict[str, Any]) -> bool:
    """Return False if any conversational message has None/missing role or content, True otherwise."""
    keys = ["messages", "prompt", "chosen", "rejected", "completion"]
    for key in keys:
